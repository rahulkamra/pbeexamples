package com.mslabs.pbe.iso.blit
{
    ...
    public class IsoBitmapSceneLayer extends BitmapDataScene implements ITickedObject
    {
        ...
        public static const COMPONENT_NAME:String = getQualifiedClassName(IsoBitmapSceneLayer).replace("::", ".");

        public function IsoBitmapSceneLayer()
        {
            updatePriority = -10;
        ...
        public static function getFrom(param1:IEntity) : IsoBitmapSceneLayer
        {
            return param1.lookupComponentByName(COMPONENT_NAME) as IsoBitmapSceneLayer;
        }// end function
